...
let serverUrls = {
  ...
  ps: "gis.psmfc.org"
// ps: "geo.psmfc.org"    // TODO: Make this a backup endpoint, eventually
}
...
let gearDDtemplate = "SELECT GearBasic, GearBasic AS GearBasic2, COUNT(DISTINCT {C}) as Count FROM vw_FishCounts_flat {W} GROUP BY GearBasic ORDER BY GearBasic";
let pocDDtemplate = "SELECT POC_LastName, COUNT(DISTINCT {C}) as Count FROM vw_FishCounts_flat {W} GROUP BY POC_LastName ORDER BY POC_LastName";
